...
export function renderstartInlineScripts( tacs ) {
  ...
  tacs.script = new Map();
  tacs.script.set('theme', cspScript('{const sT=()=>{document.documentElement.dataset.theme=localStorage.getItem("theme")||""};window.addEventListener("pageshow",e=>{e.persisted&&sT()});sT()}'));
